...
export const Banner = (props) => {
  ...
  const toRotate = ["Calculatoare", "Automatica", "Informatica"];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              {({ isVisible }) => (
                ...
                >
                  <span className="tagline">Automatica si calculatoare</span>
                  <h1>
                    {`Hai cu noi la `}{" "}
                    <span
                      className="txt-rotate"
                      dataPeriod="1000"
                      data-rotate='["Calculatoare", "Automatica", "Informatica"]'
                    >
